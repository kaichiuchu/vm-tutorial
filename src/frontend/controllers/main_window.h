...
class MainWindowController : public QMainWindow {
 ...
 private:
  ...
  std::map<int, chip8::Key> key_bindings_ = {
      {Qt::Key_0, chip8::Key::k0}, {Qt::Key_1, chip8::Key::k1},
      {Qt::Key_2, chip8::Key::k2}, {Qt::Key_3, chip8::Key::k3},
      {Qt::Key_4, chip8::Key::k4}, {Qt::Key_5, chip8::Key::k5},
      {Qt::Key_6, chip8::Key::k6}, {Qt::Key_7, chip8::Key::k7},
      {Qt::Key_8, chip8::Key::k8}, {Qt::Key_9, chip8::Key::k9},
      {Qt::Key_A, chip8::Key::kA}, {Qt::Key_B, chip8::Key::kB},
      {Qt::Key_C, chip8::Key::kC}, {Qt::Key_D, chip8::Key::kD},
      {Qt::Key_E, chip8::Key::kE}, {Qt::Key_F, chip8::Key::kF}};

 signals:
  /// Emitted when the user has pressed a key that corresponds to a CHIP-8
  /// key.
  ///
